...
- `/kit cleancdk` - 查看需要清理的CDK列表
- `/kit cleancdk confirm` - 确认清理所有已使用完的CDK
...
| `xykit.admin` | op | 管理员权限 | `/kit createcdk` `/kit reload` `/kit create` `/kit cdkinfo` `/kit cleancdk` `/kit cleancdk confirm` |
